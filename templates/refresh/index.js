...
const secret_arn  = config.domain_name
...
exports.handler = async (event) => {
    ...
    const refresh_token = request.querystring.split('=')[1]
    ...
    await axios.post(url, payload, {headers: headers}).then(res => {
        console.log("New access token retrieved successfully: " + res.status + " " + res.statusText)
        ...
        console.log("Could not retrieve new access token: " + err.code)
